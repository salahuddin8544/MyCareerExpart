...
admin.site.site_header = "mce"
admin.site.site_title = "mce Admin Panel"
admin.site.index_title = "mce Admin"
...
urlpatterns = [
    ...
    path('user/v1/api/', include('users.api.v1.urls')),
]
...
API_INFO = openapi.Info(
    title="mce API",
    default_version="v1",
    description="API documentation for mce App",
)
